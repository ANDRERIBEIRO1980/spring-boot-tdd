package com.nasoft.tdd.resources;
...
import com.nasoft.tdd.DemoApplicationTests;
...
public class PessoaResourceTest extends DemoApplicationTests {
    ...
    public void deve_procurar_pessoa_pelo_ddd_e_numero_do_telefone() throws Exception {
        //chama a requisicao abaixo
    	//.log().body() faz um debug do retorno do json
    	given()
                .pathParam("ddd", "86")
        ...
        .then()
            ...
            .and()
                ...
                .body("codigo", containsInAnyOrder(1, 3, 5),
                        "nome", containsInAnyOrder("Thiago", "Iago", "Caue"),
